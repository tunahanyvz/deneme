...
exports.run = async (client, message, args) => {
  ...
  var g = "`y!premium puan` yazarak görebilirsiniz."
  var k = "Premium Aktif Sunucular"
  var l = "`y!premium liste` yazarak görebilirsiniz."
...
message.channel.send(embed)
  ...
  if (i === "aç" || i === "aktif") {
    ...
    if (message.author.id !== "465245183332581387") return message.channel.send(`:x: Bunu Sadece Sahibim Kullanabilir !`);

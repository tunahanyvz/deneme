...
module.exports.run = async(client, message, args) => {
  ...
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .setTitle('<a:serit:559815474607816718> Yvz :bar_chart:')
    ...
    .addField(`Discord.js sürümü:`, Discord.version, true)
      .addField(':spy: Yapımcım:', '<@465245183332581387> \n `Tunahan Yavuz`', false)
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **26.03.20202**'de yapılmaya başlanmıştır", true)
    .setFooter('Yvz | Her Hakkı Saklıdır..', client.user.avatarURL)
    .setTimestamp()
